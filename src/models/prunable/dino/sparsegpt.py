...
from src.models.prunable.sparsegpt.model import SparseGPTPrunableModel

from .gradients import estimate_dino_gradients


class SparseGPTDINOPrunableModel(SparseGPTPrunableModel):
    """Clone of DINOPrunableModel, but inheriting from SparseGPTPrunableModel instead of PrunableModel."""
    def __init__(
        self,
        model: nn.Module,
        device: torch.device,
        ...
        **kwargs
        ...
        # Remove the teacher's head if any        
